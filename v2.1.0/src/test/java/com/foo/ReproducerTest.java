...
public class ReproducerTest {
    protected static final String TEST_DB_NAME = "morphia_test_16";
    ...
    public ReproducerTest() {
        ...
        this.datastore = Morphia.createDatastore(mongoClient, database.getName(), mapperOptions);
    }

    @Test
    public void reproduce() {
        datastore.getMapper().map(Dummy.class, DummyRef.class, Uid.class);
...
//        final Dummy newMorphiaVersion = dummyCursor.next();
        ...
        Assert.assertNotNull(oldMorphiaVersion.getDummyRef());
